# 外掛出發點
方便在 WP 頁面中創建一個獨立頁面與佈景主題無關攜帶有 WP 網址，頁面中的 CSS 與 JS 可以另外添加，可以外連與內連，與 WP 主題不衝突。

# Wordparss 範本檔案上傳檔案管理外掛
...
*上述上傳的範本檔案將會儲存到外掛路徑裡(修改)。

## 20260129 更新
- 修改上傳路徑:從外掛內改到uplode裡，例如:uplodes/atm/templaes。
- 添加上傳目錄安全性檢查。
## 20260408 更新
- 添加上傳CSS、JS檔案與列表頁面。
